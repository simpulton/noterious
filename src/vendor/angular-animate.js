  ...
  .config(['$provide', '$animateProvider', function($provide, $animateProvider) {
    ...
    $provide.decorator('$animate', ['$delegate', '$injector', '$sniffer', '$rootElement', '$timeout', '$rootScope',
      ...
      return {
         ...
         * | 5. $animate scans the element css to get the CSS transition/animation duration and delay  | class="my-animation ng-enter"                 |
        ...
        */
         ...
         * | 4. $animate scans the element css to get the CSS transition/animation duration and delay  | class="my-animation ng-leave"                |
        ...
        */
         ...
         * | 5. $animate scans the element css to get the CSS transition/animation duration and delay  | class="my-animation ng-move"                |
        ...
        */
         ...
         * | 4. $animate scans the element css to get the CSS transition/animation duration and delay    | class="super-add"                           |
        ...
        */
         ...
         * | 4. $animate scans the element css to get the CSS transition/animation duration and delay   | class="super super-remove"                      |
