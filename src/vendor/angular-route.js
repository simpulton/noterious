 ...
 * # ngRoute
 *
 * The `ngRoute` module provides routing and deeplinking models and directives for angular apps.
 *
 * {@installModule route}
 *
 */
...
function $RouteProvider(){
  ...
  this.when = function(path, route) {
    ...
    *
    * Inspired by pathRexp in visionmedia/express/vendor/utils.js.
    */
  ...
  this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$http', '$templateCache', '$sce',
     ...
     * @description
     * Broadcasted before a route change. At this  point the route models starts
     ...
     * visionmedia/express/vendor/router/router.js.
     */
